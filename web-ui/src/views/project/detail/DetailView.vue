<template>
  <div style="height: 100%">
    <div v-if="this.$route.query.project === undefined">
      This page access requires the parameter 'project'
    </div>
    <div v-else class="horizontal-div">
        <el-menu
            default-active="/project_detail/detect"
            ...
            :router="this.$router"
        >
          <el-menu-item index="/project_detail/detect">
            <el-icon>
              <svg t="1649057276641" class="icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg"
                   p-id="4128" width="200" height="200">
                <path
          ...
          <el-menu-item index="/project_detail/member">
            <el-icon>
              <svg t="1649068543611" class="icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg"
                   p-id="7207" width="200" height="200">
                <path
                    d="M943.5 629.1V345c0-42.4-34.5-76.9-76.9-76.9h-330l-37.3-139.3c-8.3-31.1-36.7-52.9-68.9-52.9H142.1c-40.7 0-73.9 33.1-73.9 73.9V844c0 42.4 34.5 76.9 76.9 76.9h397.2c41.3 24.6 88.6 37.8 137.9 37.8 72.1 0 139.9-28.1 190.8-79 51-51 79-118.7 79-190.8 0.1-20.4-2.2-40.4-6.5-59.8zM138.2 149.8c0-2.1 1.7-3.9 3.9-3.9h288.2c0.6 0 1.1 0.4 1.3 1L464 268.1H138.2V149.8z m0 694.2V338.1h728.3c3.8 0 6.9 3.1 6.9 6.9v155.5c-0.8-0.8-1.6-1.7-2.4-2.5-51-51-118.7-79-190.8-79s-139.9 28.1-190.8 79c-51 51-79 118.7-79 190.8 0 59.3 19 115.6 54.1 162.1H145.1c-3.8 0.1-6.9-3-6.9-6.9z m542 44.8c-110.2 0-199.9-89.7-199.9-199.9S570 489 680.2 489s199.9 89.7 199.9 199.9-89.7 199.9-199.9 199.9z"
                    p-id="7208"></path>
                <path
                    d="M771 653.9h-55.8v-55.8c0-19.3-15.7-35-35-35s-35 15.7-35 35v55.8h-55.8c-19.3 0-35 15.7-35 35s15.7 35 35 35h55.8v55.8c0 19.3 15.7 35 35 35s35-15.7 35-35v-55.8H771c19.3 0 35-15.7 35-35s-15.6-35-35-35z"
                    p-id="7209"></path>
              </svg>
            </el-icon>
            <span>成员管理</span>
          </el-menu-item>
          <el-menu-item index="/project_detail/log">
            <el-icon>
              <svg t="1649068543611" class="icon" viewBox="0 0 1024 1024" version="1.1"
                   xmlns="http://www.w3.org/2000/svg"
                   p-id="7207" width="200" height="200">
      ...
      <router-view style="float: right;width: 90%;padding: 20px" :project="project"/>
    </div>
  </div>
</template>
...
export default {
  name: "DetailView",
  data() {
    let json = this.$route.query.project
    console.log(json)
    if (json === undefined) {
      json = "{}"
    }
