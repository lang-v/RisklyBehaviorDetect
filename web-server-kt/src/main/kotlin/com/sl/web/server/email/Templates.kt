...
fun <T> T.generateResetLinkEmail(reset_url: String) =
    """
        ...
        blockquote{margin-right:0px}
                        ...
                        您正在使用邮箱<span style="color: red">重置密码</span>，请点击下方重置密码按钮，重置密码。
                    </strong><a href="$reset_url"><button style="background-color: red;color: white;border: red;width: 150px;height: 35px;font-size: 18px;border-radius: 5px">重置密码</button></a></div><div style="margin-bottom:30px;"><small style="display:block;margin-bottom:20px;font-size:12px;"><p style="color:#747474;">
                            注意：此操作可能会修改您的密码、登录邮箱或绑定手机。如非本人操作，请及时登录并修改密码以保证帐户安全
                            <br>（工作人员不会向你索取此验证码，请勿泄漏！)
                        </p></small></div></div><div style="width:700px;margin:0 auto;"><div style="padding:10px 10px 0;border-top:1px solid #ccc;color:#747474;margin-bottom:20px;line-height:1.3em;font-size:12px;"><p>此为系统邮件，请勿回复<br>
                        请保管好您的邮箱，避免账号被他人盗用
                    </p><p>南山科技团队</p></div></div></td></tr></tbody></table></body>
    """.trimIndent()
